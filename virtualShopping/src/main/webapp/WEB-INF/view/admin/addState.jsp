							...
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<f:form class="" action="insertState" modelAttribute="stateVO" method="POST">
											...
											<div class="form-group">
												<label>State Name</label> <f:input type="text"
													class="form-control" required="required" path="statename" placeholder="Type something"/>
											</div>
											
											<div class="form-group">
												<label>State Description</label>
												<div>
													<f:textarea required="required" path="statedescription" class="form-control" rows="5"></f:textarea>
												</div>
											</div>
