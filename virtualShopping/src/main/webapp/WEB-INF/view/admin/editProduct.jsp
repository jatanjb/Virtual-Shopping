							...
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<f:form class="" action="updateProduct" modelAttribute="productList" method="get">
											
											<div class="form-group">
												<label>Category Name</label>
												<f:select type="text" class="form-control" path="categoryVO.categoryId" required="required" placeholder="Type something">
									...
									<div class="form-group">
												...
												<f:select type="text" class="form-control" path="subcategoryVO.subcategoryId" required="required" placeholder="Type something">
											...
											<div class="form-group">
												 ...
												 <f:input type="hidden" path="productId" class="form-control" required="required" placeholder="Type something"/>
											</div>
											<div class="form-group">
												<label>Product Name</label>
												 <f:input type="text" path="productname" class="form-control" required="required" placeholder="Type something"/>
											</div>
											
											
											<div class="form-group">
												<label>Product price</label>
												 <f:input type="text" path="productprice" class="form-control" required="required" placeholder="Type something"/>
											</div>
											
											<div class="form-group">
												<label>Product Stock</label>
												 <f:input type="text" path="productstock" class="form-control" required="required" placeholder="Type something"/>
											</div>
											
											<div class="form-group">
												<label>Product Description</label>
												<div>
													<f:textarea required="required" class="form-control" path="productdescription" rows="5"></f:textarea>
												</div>
											</div>
