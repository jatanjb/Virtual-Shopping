							...
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<f:form class="" action="updateCity" modelAttribute="cityList" method="get">
											...
											<div class="form-group">
												 ...
												 <f:input type="hidden" path="cityId" class="form-control" required="required" placeholder="Type something"/>
											</div>
											<div class="form-group">
												<label>City Name</label>
												 <f:input type="text" path="cityname" class="form-control" required="required" placeholder="Type something"/>
											</div>
											
											<div class="form-group">
												<label>City Description</label>
												<div>
													<f:textarea required="required" class="form-control" path="citydescription" rows="5"></f:textarea>
												</div>
											</div>
