						...
						<div class="row">
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										<h4 class="mt-0 header-title">Edit Subcategory</h4>
										<%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
										<f:form class="" action="updateState" modelAttribute="stateList" method="get">
											<div class="form-group">
												
										 <f:input type="hidden" path="stateId" class="form-control" required="required" placeholder="Type something"/>
											
											<div class="form-group">
												<label>Country Name</label>
												<f:select type="text" class="form-control" path="countryVO.countryId" required="required" placeholder="Type something">
												  <options value=""> choose country</options>
											...
											<div class="form-group">
												<label>State Name</label>
												 <f:input type="text" path="statename" class="form-control" required="required" placeholder="Type something"/>
											</div>
											
											<div class="form-group">
												<label>State Description</label>
												<div>
													<f:textarea required="required" class="form-control" path="statedescription" rows="5"></f:textarea>
												</div>
											</div>
