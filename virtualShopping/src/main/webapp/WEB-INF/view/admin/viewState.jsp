					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">view State</h4>
										...
										<table id="datatable-buttons"
											...
											<tbody>
											<c:forEach items="${stateList}" var="z" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${z.countryVO.countryname}</td>
													<td>${z.stateId}</td>
													<td>${z.statename}</td>
													<td>${z.statedescription}</td>
													<td><a href="editState?stateId=${z.stateId}" class="btn btn-success waves-effect waves-light">Edit</a>
													<a href="deletestate?stateId=${z.stateId}" class="btn btn-danger waves-effect waves-light">Delete</a></td>
