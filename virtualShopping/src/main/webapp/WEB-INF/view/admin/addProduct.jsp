							...
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<f:form class="" action="insertProduct" modelAttribute="productVO" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
											...
											<div class="form-group">
												<label>Product Name</label> <f:input type="text"
													class="form-control" required="required" path="productname" placeholder="Type something"/>
											</div>
										
											<div class="form-group">
												<label>Price</label> <f:input type="text"
													class="form-control" required="required" path="productprice" placeholder="Type something"/>
											</div>
											
											
											<div class="form-group">
												<label>Stock</label> <f:input type="text"
													class="form-control" required="required" path="productstock" placeholder="Type something"/>
											</div>
											...
											<div class="form-group">
												...
												<div>
													<f:textarea required="required" path="productdescription" class="form-control" rows="5"></f:textarea>
												</div>
											</div>
