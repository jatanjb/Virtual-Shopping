							...
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<f:form class="" action="updateCategory" modelAttribute="categoryList" method="get">
											<div class="form-group">
												
												 <f:input type="hidden" path="categoryId" class="form-control" required="required" placeholder="Type something"/>
											</div>
											<div class="form-group">
												<label>Category Name</label>
												 <f:input type="text" path="categoryname" class="form-control" required="required" placeholder="Type something"/>
											</div>
											
											<div class="form-group">
												<label>Category Description</label>
												<div>
													<f:textarea required="required" class="form-control" path="categorydescription" rows="5"></f:textarea>
												</div>
											</div>
