							...
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<f:form class="" action="insertCity" modelAttribute="cityVO" method="POST">
									<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="form-group">
												<label>City Name</label> <f:input type="text"
													class="form-control" required="required" path="cityname" placeholder="Type something"/>
											</div>
											<div class="form-group">
												<label>City Description</label>
												<div>
													<f:textarea required="required" path="citydescription" class="form-control" rows="5"></f:textarea>
												</div>
											</div>
