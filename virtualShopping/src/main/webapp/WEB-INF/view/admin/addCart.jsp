						...
						<div class="row">
							<div class="col-md-12 col-xl-6">
								<div class="card m-b-30">
									<div class="card-body">
										<h4 class="mt-0 header-title">Add Cart</h4>
										<%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
										<f:form class="" action="insertCart" modelAttribute="cartVO" method="POST">
											
											<div class="form-group">
												<label>Product name</label>
												<f:select type="text" class="form-control" path="productVO.productId" required="required" placeholder="Type something">
