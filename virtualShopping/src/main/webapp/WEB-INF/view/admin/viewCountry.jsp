					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">view Country</h4>
										...
										<table id="datatable-buttons"
											...
											<tbody>
											<c:forEach items="${countryList}" var="z" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${z.countryId}</td>
													<td>${z.countryname}</td>
													<td>${z.countrydescription}</td>
													
													<td><a href="editCountry?countryId=${z.countryId}" class="btn btn-success waves-effect waves-light">Edit</a>
													<a href="deletecountry?countryId=${z.countryId}" class="btn btn-danger waves-effect waves-light">Delete</a></td>
