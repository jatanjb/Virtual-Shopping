...
<link rel="stylesheet" href="<%=request.getContextPath()%>/adminresource/css/MetroJs.min.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/adminresource/css/morris.css">
<link href="<%=request.getContextPath()%>/adminresource/css/jquery-jvectormap-2.0.2.css"
	rel="stylesheet">
...
<body class="fixed-left">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-12">
								<div class="page-title-box">
									...
									<h4 class="page-title">virtual shopping with artificial salesmen</h4>
								</div>
							</div>
						</div>
							...
							<div class="col-md-12 col-xl-3">
								<div class="card mini-stat">
									...
									<div class="p-4">
										...
										<h4 class="mb-0">
											34578<small class="ml-2"><i
												class="mdi mdi-arrow-up text-primary"></i></small>
										</h4>
									</div>
								</div>
							</div>
							<div class="col-md-12 col-xl-3">
								<div class="card mini-stat">
									...
									<div class="p-4">
										...
										<h4 class="mb-0">
											895<small class="ml-2"><i
												class="mdi mdi-arrow-down text-danger"></i></small>
										</h4>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-xl-4">
								<div class="card">
									<div class="card-body">
										<a href="" class="btn btn-light btn-sm float-right">More
											Info</a>
										...
										<ul class="list-unstyled list-inline text-center mb-0 mt-3">
											<li class="list-inline-item"><p class="mb-0">
													<i class="mdi mdi-checkbox-blank-circle mr-2 text-success"></i>Profit
												</p></li>
											<li class="list-inline-item"><p class="mb-0">
													<i class="mdi mdi-checkbox-blank-circle mr-2 text-danger"></i>Lost
												</p></li>
										</ul>
									</div>
								</div>
									...
									<div class="card-body">
										<div class="row">
											<div class="col-md-4">
												...
												<div class="mt-3">
													<h3 class="mb-1">
														528,580<small class="font-12 text-muted ml-1">last
															3 weeks</small>
													</h3>
												</div>
											</div>
											<div class="col-md-4">
												<div class="card">
													<div class="card-body text-center">
														<img src="<%=request.getContextPath()%>/adminresource/image/us_flag.jpg" alt=""
															class="w-30"> <span class="ml-2">35%<i
											...
											<div class="col-md-4">
												<div class="card">
													<div class="card-body text-center">
														<img src="<%=request.getContextPath()%>/adminresource/image/russia_flag.jpg" alt=""
															class="w-30"> <span class="ml-2">65%<i
												...
												<tbody>
													<tr>
														<td><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminresource/image/avatar-1.jpg" alt="user"
															width="40"></td>
														<td><a href="javascript:void(0);" class="text-dark">James
																k. Striplin</a></td>
														<td>18/05/2018 3:01 PM</td>
														<td><img src="<%=request.getContextPath()%>/adminresource/image/us_flag.jpg" alt=""
															class="w-30"></td>
														<td>9932AZ</td>
														<td><span class="badge badge-boxed badge-primary">Shipped</span></td>
													</tr>
													<tr>
														<td><img class="rounded-circle w-50"
															src="<%=request.getContextPath()%>/adminresource/image/avatar-2.jpg" alt="user"></td>
														<td><a href="javascript:void(0);" class="text-dark">William
																A. Johnson</a></td>
														<td>28/05/2018 9:20 AM</td>
														<td><img src="<%=request.getContextPath()%>/adminresource/image/french_flag.jpg"
															alt="" class="w-30"></td>
														<td>2643BZ</td>
													...
													<tr>
														<td><img class="rounded-circle w-50"
															src="<%=request.getContextPath()%>/adminresource/image/avatar-3.jpg" alt="user"></td>
														<td><a href="javascript:void(0);" class="text-dark">Bobby
																M. Gray</a></td>
														<td>3/05/2018 8:45 PM</td>
														<td><img src="<%=request.getContextPath()%>/adminresource/image/spain_flag.jpg"
															alt="" class="w-30"></td>
														<td>2458DA</td>
													...
													<tr>
														<td><img class="rounded-circle w-50"
															src="<%=request.getContextPath()%>/adminresource/image/avatar-4.jpg" alt="user"></td>
														<td><a href="javascript:void(0);" class="text-dark">Sona
																J. Medrano</a></td>
														<td>25/05/2018 6:35 PM</td>
														<td><img src="<%=request.getContextPath()%>/adminresource/image/russia_flag.jpg"
															alt="" class="w-30"></td>
														<td>7845AA</td>
														<td><span class="badge badge-boxed badge-primary">Shipped</span></td>
													</tr>
													<tr>
														<td><img class="rounded-circle w-50"
															src="<%=request.getContextPath()%>/adminresource/image/avatar-5.jpg" alt="user"></td>
														<td><a href="javascript:void(0);" class="text-dark">Ruby
																T. Curd</a></td>
														<td>12/05/2018 10:42 AM</td>
														<td><img src="<%=request.getContextPath()%>/adminresource/image/italy_flag.jpg"
															alt="" class="w-30"></td>
														<td>4451CA</td>
														<td><span class="badge badge-boxed badge-warning">Pending</span></td>
													</tr>
	...
	<script src="<%=request.getContextPath()%>/adminresource/js/MetroJs.min.js"></script>
	<script src="<%=request.getContextPath()%>/adminresource/js/jquery-jvectormap-2.0.2.min.js"></script>
	<script src="<%=request.getContextPath()%>/adminresource/js/jquery-jvectormap-world-mill-en.js"></script>
	...
	<script src="<%=request.getContextPath()%>/adminresource/js/raphael-min.js"></script>
