								...
								<div class="card">
									<div class="card-body">
										...
										<table id="datatable-buttons"
											...
											<tbody>
											<c:forEach items="${productList}" var="z" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${z.categoryVO.categoryname}</td>
													<td>${z.subcategoryVO.subcategoryname}</td>
													<td>${z.productname}</td>
													<td>${z.productprice}</td>
													<td>${z.productstock}</td>
													<td>
													
													<a href="<%=request.getContextPath()%>/documents/productImage/${z.productImageName}">
														<img src = "<%=request.getContextPath()%>/documents/productImage/${z.productImageName}" style="height:20px ; width:20px" alt="${z.productImageName}">
													</a>
													
													</td>
													<td>${z.productdescription}</td>
													<td><a href="editProduct?productId=${z.productId}" class="btn btn-success waves-effect waves-light">Edit</a>
													<a href="deleteproduct?productId=${z.productId}" class="btn btn-danger waves-effect waves-light">Delete</a></td>
