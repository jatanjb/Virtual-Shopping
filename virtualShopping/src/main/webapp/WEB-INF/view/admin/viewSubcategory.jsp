					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">view Subcategory</h4>
										...
										<table id="datatable-buttons"
											...
											<tbody>
											<c:forEach items="${subcategoryList}" var="z" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${z.categoryVO.categoryname}</td>
													<td>${z.subcategoryId}</td>
													<td>${z.subcategoryname}</td>
													<td>${z.subcategorydescription}</td>
													<td><a href="editSubcategory?subcategoryId=${z.subcategoryId}" class="btn btn-success waves-effect waves-light">Edit</a>
													<a href="deletesubcategory?subcategoryId=${z.subcategoryId}" class="btn btn-danger waves-effect waves-light">Delete</a></td>
