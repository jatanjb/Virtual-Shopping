					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">view City</h4>
										...
										<table id="datatable-buttons"
											...
											<tbody>
													<c:forEach items="${cityList}" var="z" varStatus="j">
												<tr>
													<td>${j.count}</td>
													...
													<td><a href="editCity?cityId=${z.cityId}" class="btn btn-success waves-effect waves-light">Edit</a>
													<a href="deletecity?cityId=${z.cityId}" class="btn btn-danger waves-effect waves-light">Delete</a></td>
