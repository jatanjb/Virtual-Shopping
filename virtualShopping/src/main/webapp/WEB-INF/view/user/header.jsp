            ...
            <div class="header-middle-left">
              <div class="navbar-header float-none-sm">
                <a class="navbar-brand page-scroll" href="index.html">
                  <img alt="Stylexpo" src="<%=request.getContextPath()%>/userResources/images/logo.png">
                </a> 
              </div>
            </div>
          </div>
                  ...
                  <div class="cart-dropdown header-link-dropdown">
                    <ul class="cart-list link-dropdown-list">
                      <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                        <div class="media"> <a class="pull-left"> <img alt="Stylexpo" src="<%=request.getContextPath()%>/userResources/images/1.jpg"></a>
                      ...
                      <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                        <div class="media"> <a class="pull-left"> <img alt="Stylexpo" src="<%=request.getContextPath()%>/userResources/images/2.jpg"></a>
                          <div class="media-body"> <span><a href="#">Black African Print Skirt</a></span>
                            <p class="cart-price">$14.99</p>
                            <div class="product-qty">
                              <label>Qty:</label>
                                  ...
                                  <div class="row">
                                    <div class="owl-carousel sub_menu_slider">
                                      ...
                                      <div class="product-item">
                                        <div class="product-image"> 
                                          <a href="product-page.html"> 
                                            <img src="<%=request.getContextPath()%>/userResources/images/6.jpg" alt="Stylexpo"> 
                                          </a>
                                          <div class="product-detail-inner">
                                            <div class="detail-inner-left align-center">
                                              <ul>
                                      ...
                                      <div class="product-item">
                                        <div class="product-image"> 
                                          <a href="product-page.html"> 
                                            <img src="<%=request.getContextPath()%>/userResources/images/8.jpg" alt="Stylexpo"> 
                                          </a>
                                          <div class="product-detail-inner">
                                            <div class="detail-inner-left align-center">
                                              <ul>
                                      ...
                                      <div class="product-item">
                                        <div class="product-image"> 
                                          <a href="product-page.html"> 
                                            <img src="<%=request.getContextPath()%>/userResources/images/16.jpg" alt="Stylexpo"> 
                                          </a>
                                          <div class="product-detail-inner">
                                            <div class="detail-inner-left align-center">
                                              <ul>
                            ...
                            <div class="megamenu-inner-top">
                              <ul class="sub-menu-level1">
                                ...
                                <li class="level2 d-none d-lg-block">
                                  <a href="shop.html">
                                    <img src="<%=request.getContextPath()%>/userResources/images/drop_banner.jpg" alt="Stylexpo">
                                  </a>
                                </li>
                              </ul>
                            </div>
                ...
                <div class="nav_sec position-r">
                  ...
                  <div class="mobilemenu-content">
                    <ul class="nav navbar-nav" id="menu-main">
                      ...
                      <li>
                        <a href="shop.html"><span>Product</span></a>
                      </li>
                      <li class="level dropdown ">
                        <span class="opener plus"></span>
                        <a href="#" class="page-scroll"><span>Complain</span></a>
                        <div class="megamenu mobile-sub-menu">
                          <div class="megamenu-inner-top">
                            <ul class="sub-menu-level1">
                              <li class="level2">
                                <ul class="sub-menu-level2 ">
                                  <li class="level3"><a href="account.html"><span>■</span>Post Complain</a></li>
                                  <li class="level3"><a href="checkout.html"><span>■</span>View Complain</a></li>
                                </ul>
                              </li>
                            </ul>
                          </div>
                      ...
                      <!-- <li>
                        <a href="about.html"><span>Complain</span></a>
                      </li> -->
                      <li>
                        <a href="blog.html"><span>FeedBack</span></a>
                      </li>
                      <li>
