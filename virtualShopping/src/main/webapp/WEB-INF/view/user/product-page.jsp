      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="row">
            <div class="col-lg-5 col-md-5 mb-xs-30">
              <div class="fotorama" data-nav="thumbs" data-allowfullscreen="native"> <a href="#"><img src="<%=request.getContextPath()%>/userResources/images/1.jpg" alt="Stylexpo"></a> <a href="#"><img src="<%=request.getContextPath()%>/userResources/images/2.jpg" alt="Stylexpo"></a> <a href="#"><img src="<%=request.getContextPath()%>/userResources/images/3.jpg" alt="Stylexpo"></a> <a href="#"><img src="<%=request.getContextPath()%>/userResources/images/4.jpg" alt="Stylexpo"></a> <a href="#"><img src="<%=request.getContextPath()%>/userResources/images/5.jpg" alt="Stylexpo"></a> <a href="#"><img src="<%=request.getContextPath()%>/userResources/images/6.jpg" alt="Stylexpo"></a> <a href="#"><img src="<%=request.getContextPath()%>/userResources/images/4.jpg" alt="Stylexpo"></a> <a href="#"><img src="<%=request.getContextPath()%>/userResources/images/5.jpg" alt="Stylexpo"></a> <a href="#"><img src="<%=request.getContextPath()%>/userResources/images/6.jpg" alt="Stylexpo"></a> </div>
            </div>
        ...
        <div class="col-lg-3">
          <div class="brand-logo-pro align-center mb-30">
            <img src="<%=request.getContextPath()%>/userResources/images/brand5.png" alt="Stylexpo">
          </div>
          <div class="sub-banner-block align-center">
            <img src="<%=request.getContextPath()%>/userResources/images/pro-banner.jpg" alt="Stylexpo">
          </div>
        </div>
      </div>
    </div>
                    ...
                    <div class="items-Reviews">
                      <div class="comments-area">
                        ...
                        <ul class="comment-list mt-30">
                          <li>
                            <div class="comment-user"> <img src="<%=request.getContextPath()%>/userResources/images/comment-user.jpg" alt="Stylexpo"> </div>
