                ...
                <tbody>
                  <tr>
                    <td>
                      ...
                      <div class="product-image"><img alt="Stylexpo" src="<%=request.getContextPath()%>/userResources/images/1.jpg"></div>
                      </a>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <a href="product-page.html">
                        <div class="product-image"><img alt="Stylexpo" src="<%=request.getContextPath()%>/userResources/images/2.jpg"></div>
                      </a>
                    </td>
                    <td>
                     <div class="product-title"> 
